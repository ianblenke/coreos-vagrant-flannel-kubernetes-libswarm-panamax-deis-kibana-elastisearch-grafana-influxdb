...
[ "$ENABLE_PANAMAX" = "true" ] && cat panamax.yml >> user-data
...
[ "$ENABLE_KUBERNETES" = "true" ] && (
  cat kubernetes-master.yml | vagrant ssh $MASTER -c "cat - > master.yml ; sudo /usr/bin/coreos-cloudinit --from-file=/home/core/kubernetes-master.yml"
)
